        ...
        describe('ArticlesController', function() {
            ...
            it('$scope.find() should create an array with at least one article object ' +
                'fetched from XHR', function() {
                    ...
                    $httpBackend.expectGET('articles').respond([{
                        title: 'An Article about arenahelper',
                        content: 'arenahelper rocks!'
                    }]);
            ...
            it('$scope.create() with valid form data should send a POST request ' +
                ...
                'locate to new object URL', function() {
                    ...
                    scope.title = 'An Article about arenahelper';
                    scope.content = 'arenahelper rocks!';
            ...
            it('$scope.update() should update a valid article', inject(function(Articles) {
                ...
                EXPECTED: {"_id":"525a8422f6d0f87f0e407a33","title":"An Article about arenahelper","to":"arenahelper is great!"}
                GOT:      {"_id":"525a8422f6d0f87f0e407a33","title":"An Article about arenahelper","to":"arenahelper is great!","updated":[1383534772975]}
                */
